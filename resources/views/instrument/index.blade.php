  ...
  let instrument_id
    ...
    $(".delete-mem-btn").click(()=>{
      ...
      $.ajax({
          ...
          sessionStorage.setItem("message", "Instrument Deleted Successfully");
    ...
    $(document).ready(()=>{
        ...
        if(instruments.length!=0){
            ...
            $('.t-content').append('<tr><td></td><td></td><td class="text-center">No Data Found!</td><td></td><td></td><td></td></tr>')
        }
        $('.table').DataTable()
