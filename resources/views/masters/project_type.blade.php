...
<script>
    ...
    function open_edit_model(e){
            ...
            url: api_url+'master/project_type',
              ...
              $('#project_type_id').val(btoa(project_type.id));
    ...
    function type_delete(){
      ...
      url: api_url+'master/project_type',
        ...
        sessionStorage.setItem("message", "Project Type Deleted Successfully");
        ...
        if(data.name == ''){
          ...
          if($("#project_type_id").val() == ''){
            ...
            url: api_url+'master/project_type',
              ...
              sessionStorage.setItem("message", "Project Type Added Successfully");
                window.location='{{route("projectType")}}'
            })
          }
            ...
            let data={
            'project_type_id': atob($("#project_type_id").val()),
            'name': $("#name").val() }
            ...
            url: api_url+'master/project_type_update',
              ...
              sessionStorage.setItem("message", "Project Type Edited Successfully");
                window.location='{{route("projectType")}}'
            })
          }
