    ...
    <div class="modal-content">
      ...
      <div class="">
        <div class="card">
          <div class="card-body">
            <div class="mb-3">
              <label for="name" class="form-label">Work Order Type Name</label>
...
<script>
    ...
    function open_edit_model(e){
            ...
            url: api_url+'master/work_order_type',
              ...
              $('#work_order_type_id').val(btoa(work_order_type.id));
    ...
    function type_delete(){
      ...
      let data={
            'work_order_type_id': atob($('#delete_type_id').val()) }
      ...
      url: api_url+'master/work_order_type',
        ...
        sessionStorage.setItem("message", "Work Order Type Deleted Successfully");
        ...
        if(data.name == ''){
          ...
          if($("#work_order_type_id").val() == ''){
            ...
            url: api_url+'master/work_order_type',
              ...
              sessionStorage.setItem("message", "Work Order Type Added Successfully");
                window.location='{{route("work_orderType")}}'
            })
          }
            ...
            let data={
            'work_order_type_id': atob($("#work_order_type_id").val()),
            'name': $("#name").val() }
            ...
            url: api_url+'master/work_order_type_update',
              ...
              sessionStorage.setItem("message", "Work Order Type Edited Successfully");
                window.location='{{route("work_orderType")}}'
            })
          }
