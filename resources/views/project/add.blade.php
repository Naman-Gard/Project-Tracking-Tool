        ...
        <div class="col-12">
            ...
            <div class="card-body">
                <form>
                    ...
                    <div class="col-md-6">
                    <label for="exampleFormControlInput1" class="form-label">Client Department</label>
                    <input class="form-control" name="client_dep" type="text" placeholder="Client Department" value="{{old('client_dep')}}" autocomplete="off">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="p_stage" class="form-control">
                            <option value="">Select</option>
...
<script>
    ...
    function Submit(){
        ...
        if(flag){
            ...
            let data={
                ...
                'client_department': $("input[name=client_dep]").val(),
    ...
    function doValidations(){
        ...
        if($("input[name=client_dep]").val()){
            $('.valid_client_dep').html('')
            flag5=true
        }else{
            $('.valid_client_dep').html('The project description field is required.')
            flag5=false
        }
